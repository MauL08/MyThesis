...
Harga dari perhitungan tersebut dapat digunakan oleh pembudidaya untuk menjadi harga dasar dalam penjualannya. Tentunya harga tersebut belum bisa menjadi acuan jual karena ada faktor eksternal yang menentukan harga jual ikan tergantung pada kondisi pasar.
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.32\textwidth]{gambar/sprint1/mockup_home.png}
			\caption{Menu Inventaris pada Halaman Home}
		\end{figure}
		...
		Detail dari Sprint 2 ini adalah mengerjakan tugas yang ada pada Sprint 2 Backlog di \textbf{Tabel 3.3}.

		Berikut merupakan alur user sebagai pengguna aplikasi berdasarkan mockup yang sudah dibuat pada Sprint 1.

		\begin{figure}[H]
			\centering
			\includegraphics[width=1\textwidth]{gambar/sprint2/flow_feed.png}
			\caption{Skema Database Fitur Inventaris}
		\end{figure}
		\begin{figure}[H]
			\centering
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=1\textwidth]{gambar/sprint2/flow_electric.png}
			\caption{Skema Database Fitur Inventaris}
		\end{figure}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=1\textwidth]{gambar/sprint2/inventory_schema.png}
			\caption{Skema Database Fitur Inventaris}
		\end{figure}
