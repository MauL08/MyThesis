...
Pada jurnal yang diterbitkan oleh \citep{uat} tentang UAT, \textit{User Acceptance Test} (UAT) adalah tahap akhir pengujian dalam pengembangan perangkat lunak. Ketika hasil pengujian memenuhi kriteria, sistem perangkat lunak dapat dirilis untuk penggunaan operasional.
