...
MongoDB merupakan database NoSQL yang dikembangkan oleh MongoDB Inc yang rilis pada tahun 2009 \citep{mongodbweb}. Database ini disebut NoSQL karena berbasis objek atau bisa disebut JSON (JavaScript Object Notation), berbeda dengan MySQL yang berbasis tabel dalam penggunaannya.
...
Pada \textbf{Gambar 2.6}, dapat dilihat skema penggunaan REST API yang melibatkan client dan database. REST API bekerja dengan cara menerima request yang melibatkan database dan memberikan response kepada client dengan perantara komunikasi seperti HTTP.
