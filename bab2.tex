	...
	\begin{table}[h!]
		\begin{center}
		  ...
		  \begin{tabular}{l|c|r} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
			\textbf{Tanggal} & \textbf{Deskripsi} & \textbf{Unit dan Biaya} \\
			\hline
			3 Mei & Inventaris awal & 70 unit, \${15} per unit\\
			6 Mei & Beli &  125 unit, \${10} per unit\\
			10 Mei & Beli &  90 unit, \${20} per unit\\
			13 Mei & Jual &  40 unit, \${15} per unit\\
			16 Mei & Beli &  50 unit, \${15} per unit\\
			23 Mei & Jual &  100 unit, \${20} per unit\\
			29 Mei & Jual &  70 unit, \${20} per unit\\
		  \end{tabular}
		\end{center}
	  \end{table}
